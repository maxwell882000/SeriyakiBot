...
def create_dish(name, name_uz, description, description_uz, image, price, quantity, category_id, show_usd=False, cooking_time=0):
    check_quantity = ''
...
def update_dish(dish_id, name, name_uz, description, description_uz, image, price, category_id, delete_image, show_usd, quantity, cooking_time):
